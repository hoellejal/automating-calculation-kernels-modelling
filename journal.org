...
*** 2019-05-09 thursday
**** STARTED An example with generated quantities
:LOGBOOK:  
...
generated quantities {
  vector[N-1] y_pos; // posterior predictions
  for (n in 1:(N-1))
...
Inference for Stan model: 1320753aed3b274adf33c75cc2f6ee92.
8 chains, each with iter=500; warmup=250; thin=1; 
post-warmup draws per chain=250, total post-warmup draws=2000.

                mean se_mean    sd     2.5%      25%      50%      75%    97.5%  n_eff  Rhat
intercept      12.05    0.04  1.31     9.40    11.17    12.10    12.98    14.42    888  1.01
coefficient     3.00    0.00  0.02     2.96     2.99     3.00     3.02     3.05    921  1.01
sigma          14.55    0.01  0.45    13.77    14.24    14.54    14.84    15.46   1359  1.01
lp__        -1588.56    0.04  1.20 -1591.77 -1589.06 -1588.24 -1587.68 -1587.20    783  1.01
                   
Samples were drawn using NUTS(diag_e) at Thu May  9 09:55:30 2019.
For each parameter, n_eff is a crude measure of effective sample size,
and Rhat is the potential scale reduction factor on split chains (at 
convergence, Rhat=1).
#+end_example
