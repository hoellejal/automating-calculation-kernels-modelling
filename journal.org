...
*** 2019-06-20 thursday
**** Finished the slides
**** Plotting the posterior with a M_H-1 N_H-2 model
#+begin_src R :results output :session *R* :exports both
library(rstan)
library(dplyr)
...
post-warmup draws per chain=250, total post-warmup draws=1000.
                     ...
                     mean      se_mean           sd          2.5%           25%
intercept[1] 9.543856e-06 4.586447e-07 2.048894e-05 -2.937878e-05 -4.331748e-06
mu[1]        7.036400e-11 1.140000e-13 4.623000e-12  6.139800e-11  6.733000e-11
sigma[1]     1.002050e-10 5.000000e-15 2.020000e-13  1.000060e-10  1.000620e-10
noise[1]     2.554964e-05 3.291607e-07 1.182350e-05  1.078725e-05  1.593036e-05
                      50%          75%        97.5% n_eff      Rhat
intercept[1] 1.010669e-05 2.381342e-05 4.862562e-05  1996 0.9991379
mu[1]        7.043300e-11 7.350200e-11 7.887600e-11  1634 0.9970547
sigma[1]     1.001470e-10 1.002860e-10 1.007090e-10  1752 0.9978440
noise[1]     2.303954e-05 3.259384e-05 5.371958e-05  1290 1.0007677

Samples were drawn using NUTS(diag_e) at Thu Jun 20 13:03:15 2019.
For each parameter, n_eff is a crude measure of effective sample size,
and Rhat is the potential scale reduction factor on split chains (at 
convergence, Rhat=1).
#+end_example
