...
#+RESULTS:
#+begin_example
Inference for Stan model: 9b36de8503b4c2eb2dac2af3794b006a.
8 chains, each with iter=500; warmup=250; thin=1; 
post-warmup draws per chain=250, total post-warmup draws=2000.

                  mean se_mean    sd     2.5%      25%      50%      75%
intercept       125.69    1.17 19.11    88.25   112.41   126.28   138.38
first_degree      4.84    0.05  0.88     3.16     4.25     4.82     5.42
second_degree     2.01    0.00  0.01     1.99     2.00     2.01     2.02
sigma           147.46    0.14  4.67   138.53   144.41   147.27   150.55
lp__          -2740.89    0.07  1.40 -2744.25 -2741.63 -2740.57 -2739.85
                 97.5% n_eff Rhat
intercept       164.47   267 1.03
first_degree      6.65   331 1.02
second_degree     2.03   424 1.02
sigma           156.55  1045 1.00
lp__          -2739.16   445 1.02

Samples were drawn using NUTS(diag_e) at Mon May 13 16:26:10 2019.
For each parameter, n_eff is a crude measure of effective sample size,
and Rhat is the potential scale reduction factor on split chains (at 
convergence, Rhat=1).
#+end_example
