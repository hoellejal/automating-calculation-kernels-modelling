...
fit = sampling(sm,data=dt, iter=400, chains=3,init=initfunction, control=list(adapt_delta=0.9,max_treedepth=15))
#+end_src
...
However the chains don't converge in the trace except for mu. It isn't
so surprising considering giving a prior is considered one of the good
practices in stan, and the more accurate the prior, the more accurate
the results (without a big amount of data). As a fact, it is
surprising that the results could get so "close" to the
usual ones, and that's due to the init values given, that
...
post-warmup draws per chain=200, total post-warmup draws=600.
                    ...
                    mean      se_mean           sd         2.5%          25%
mu_alpha    7.002200e-11 2.300000e-14 6.200000e-13 6.881600e-11 6.958300e-11
mu_beta     4.955480e-06 2.357207e-08 6.666410e-07 3.643649e-06 4.542632e-06
mu_teta     1.000030e-10 0.000000e+00 3.000000e-15 1.000000e-10 1.000010e-10
mu_gamma    1.009315e-05 2.857858e-09 9.182736e-08 1.000296e-05 1.002711e-05
sigma_alpha 1.079000e-12 5.400000e-14 7.920000e-13 2.400000e-14 4.260000e-13
sigma_beta  9.903481e-07 3.095171e-08 7.812637e-07 4.444671e-08 3.936288e-07
sigma_teta  4.000000e-15 0.000000e+00 4.000000e-15 0.000000e+00 1.000000e-15
sigma_gamma 1.181155e-07 4.009874e-09 1.330543e-07 3.502910e-09 2.855143e-08
                     50%          75%        97.5% n_eff      Rhat
mu_alpha    6.999300e-11 7.045500e-11 7.119700e-11   750 0.9968888
mu_beta     4.954161e-06 5.413054e-06 6.236904e-06   800 0.9980150
mu_teta     1.000020e-10 1.000040e-10 1.000100e-10  1273 0.9968033
mu_gamma    1.006620e-05 1.012748e-05 1.035001e-05  1032 1.0012824
sigma_alpha 9.450000e-13 1.594000e-12 2.913000e-12   217 0.9990420
sigma_beta  8.019817e-07 1.437840e-06 2.918170e-06   637 1.0000415
sigma_teta  3.000000e-15 6.000000e-15 1.600000e-14   831 0.9976975
sigma_gamma 7.435250e-08 1.634610e-07 5.059164e-07  1101 0.9968615

Samples were drawn using NUTS(diag_e) at Tue Jun 18 17:07:24 2019.
For each parameter, n_eff is a crude measure of effective sample size,
and Rhat is the potential scale reduction factor on split chains (at 
convergence, Rhat=1).
#+end_example
...
#+RESULTS:
[[file:/tmp/babel-13758dV0/figure13758PfD.png]]
