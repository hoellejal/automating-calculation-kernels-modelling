...
dt = list(N=500,hosts=length(unique(tmp$cpu)),mnk=mnk,duration=duration,beta_mean=1e-05,beta_sd=1e-06,alpha_mean=c(6.5e-11,7.5e-11),alpha_sd=c(1e-11,1e-11),gamma_mean=1e-05,gamma_sd=1e-06,theta_mean=1e-10,theta_sd=1e-11)
initfunction=function(){
list(mu_alpha=c(6.5e-11,7.5e-10),mu_beta=1e-05,mu_theta=1e-10,mu_gamma=1e-05,sigma_alpha=c(2e-10,2e-10),sigma_beta=1e-06,sigma_theta=1e-11,sigma_gamma=1e-06)
}

fit = sampling(sm,data=dt, iter=500, chains=4,init=initfunction,control=list(adapt_delta=0.99,max_treedepth=15))
print(fit,digits=15,pars=c("delta","mu_alpha","mu_beta","mu_theta","mu_gamma","sigma_alpha","sigma_beta","sigma_theta","sigma_gamma"))
png('trace_yet_another_hierarchical.png')
stan_trace(fit,pars=c("delta","mu_alpha","mu_beta","mu_theta","mu_gamma","sigma_alpha","sigma_beta","sigma_theta","sigma_gamma"))
dev.off()
extracted=rstan::extract(fit)
d=data.frame(extracted$delta, extracted$mu_alpha,extracted$mu_beta,extracted$mu_theta,extracted$mu_gamma,extracted$sigma_alpha,extracted$sigma_beta,extracted$sigma_theta,extracted$sigma_gamma)
names(d)=c("delta","mu_alpha.1","mu_alpha.2","mu_beta","mu_theta","mu_gamma","sigma_alpha.1","sigma_alpha.2","sigma_beta","sigma_theta","sigma_gamma")
mu_alpha=matrix(c(d$mu_alpha.1,d$mu_alpha.2),nrow=length(d$mu_alpha.1),byrow=T)
png('hist_prout.png')
hist(mu_alpha)
