...
#+AUTHOR:      Hoël Jalmin
#+LANGUAGE:    en
#+SEQ_TODO: TODO(t!) STARTED(s!) INTERRUPTED(i!) REWORK (r!) DONE(d!)
...
*** 2019-05-09 thursday
**** DONE An example with generated quantities :STAN:R:
:LOGBOOK:  
...
wrong, because the chains don't converge towards each other at all. We
follow stan's advice to look at the pairs plot.
...
energy__, however I don't really understand how to read this plot.
